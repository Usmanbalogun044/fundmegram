...
<head>
    <meta charset="UTF-8">
    <title>Campaign Approved - {{ $title_site }}</title>
    <style>
        @keyframes pop {
...
<body style="font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); text-align: center;">
        ...
        <h2 style="color: #333; margin-top: 15px;">Your Campaign is Approved! 🎉</h2>
        <p>Dear <strong>{{ $username }}</strong>,</p>
        <p>We are excited to inform you that your campaign <strong>{{ $campaign }}</strong> has been successfully <span style="color: #22c55e; font-weight: bold;">approved</span>!</p>
        ...
        <p>Thank you for using {{ $title_site }}!</p>

        <!-- CTA Button -->
        <a href="{{ url('/') }}" style="display: inline-block; margin-top: 15px; padding: 10px 20px; background-color: #22c55e; color: #fff; text-decoration: none; border-radius: 5px;">View Your Campaign</a>
