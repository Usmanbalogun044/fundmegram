...
<body class="bg-gray-100 flex justify-center items-center min-h-screen">
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-lg">
        <h2 class="text-center text-2xl font-bold text-gray-800 mb-6">cashapp Donation</h2>
        ...
        <div class="bg-gray-100 p-4 rounded-lg border mb-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-2">cashapp Details</h3>
            <p class="text-gray-700">{!! nl2br(e($bank)) !!}</p>
        </div>

        <form action="{{ route('payment.cashapp', ['id' => $campaign->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
