...
@section('content')
    ...
    <a class="text-reset" href="{{ url('panel/admin') }}">{{ __('admin.dashboard') }}</a>
      ...
      <i class="bi-chevron-right me-1 fs-6"></i>
      <span class="text-muted">cashapp</span>
  </h5>
	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
			...
			<div class="card shadow-custom border-0">
				...
				<form method="POST" action="{{route('set.cashapp',['id'=>$data->id])}}" enctype="multipart/form-data">
             @csrf
            ...
            {{-- <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">cashapp tag</label>
		          <div class="col-sm-10">
